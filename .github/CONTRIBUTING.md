...
* Create a fork of this repository, then clone the fork to your local development environment: `git clone https://github.com/YOUR_USERNAME/react-test-context-provider.git`
...
* [Submit a pull request](https://github.com/alanbsmith/react-test-context-provider/compare) to the upstream `styled-components-modifiers` repository.
